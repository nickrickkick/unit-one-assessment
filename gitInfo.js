...
//CODE HERE
var gitDefinition = "git is a way to distributed revision control system. it move and can change info in a file.";
...
//CODE HERE
var gitHubDefinition = "github is a place to use git to move files and get files from the cloud.";
...
//CODE HERE
var gitInitDefinition = "git init is to create a git repostiory and its the first thing you have to do before you can use git for your files.";
...
//CODE HERE
var gitCloneDefinition = "git clone is to create a clone of the repostiory into a new directory and you can use this a remote way to work on the files and later push and fetch from the origin master.";
